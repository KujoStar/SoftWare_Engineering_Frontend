...
* @returns {string}
*/
export function fucking_frontend_hash(password, salt) {
    let deferred3_0;
    let deferred3_1;
    try {
        ...
        wasm.fucking_frontend_hash(retptr, ptr0, len0, ptr1, len1);
        ...
        wasm.__wbindgen_export_2(deferred3_0, deferred3_1);
    }
}
...
export function md5(content) {
    ...
    try {
        ...
        wasm.__wbindgen_add_to_stack_pointer(16);
        wasm.__wbindgen_export_2(deferred2_0, deferred2_1);
    }
}
...
* @returns {string}
*/
export function blake3(content) {
    let deferred2_0;
    let deferred2_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
export function __wbg_log_dc06ec929fc95a20(arg0) {
